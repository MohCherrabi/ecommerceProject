                ...
                <div class="card-body">
                    <form action="{{ route('orders.update',$order->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="">
                                <input class="form-control" type="date" value="{{ $order->date }}" name="date"
                                    id="html5-date-input" />
                                @error('date')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="">
                                <input class="form-control" type="time" value="{{ $order->hour }}" name="hour"
                                    id="html5-time-input" />
                                @error('hour')
                                    <div class="alert text-danger">
                                        {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mt-3">
                                <input name="payment" class="form-check-input" type="radio" value="1" @if( $order->payment == 1) checked=''@endif
                                    id="defaultRadio1">
                                <label class="form-check-label" for="defaultRadio1"> Yes </label>
                            </div>
                            <div class="form-check mt-3">
                                <input name="payment" class="form-check-input" type="radio" value="0"  @if( $order->payment ==0) checked=''@endif
                                    id="defaultRadio1">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="payment_mode_id" class="form-select" id="exampleFormControlSelect1"
                                ...
                                @foreach ($payment_modes as $payment_mode)
                                    @if ($order->payment_mode_id == $payment_mode->id)
