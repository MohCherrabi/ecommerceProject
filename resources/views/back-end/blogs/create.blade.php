                    ...
                    <div class="card-body">
                      <form action="{{route('blogs.store')}}" method="POST"  enctype="multipart/form-data" >
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" value="{{old('title')}}" name="title" class="form-control" id="basic-default-fullname" placeholder="" />
                          @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old('description')}}" name="description" class="form-control" id="basic-default-fullname" placeholder="" />
                            @error('description')
                            <div class="alert text-danger">
                              {{$message}}
                          </div>
