                ...
                <div class="card-body">
                    <form action="{{ route('products.store') }}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" @if(old('special_offer')) checked="" @endif  type="checkbox"  id="defaultCheck3" name="special_offer">
                            <label class="form-check-label" for="defaultCheck3"> Special offer </label>
                          </div>
