                ...
                <div class="card-body">
                    <form action="{{ route('products.update',$product->id) }}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $product->price_ht }}" step="0.1" name="price_ht" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{$product->new_price_ht }}" step="0.1" name="new_price_ht" class="form-control"
                                id="basic-default-fullname" placeholder="12.33" />
                            @error('new_price_ht')
                                <div class="alert text-danger">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $product->VAT }}" step="0.1" name="VAT" class="form-control"
                                id="basic-default-fullname" placeholder="12.33" />
                            @error('VAT')
                                <div class="alert text-danger">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $product->description }}" step="0.1" name="description" class="form-control"
                        ...
                        <div class=" mb-3">
                            ...
                            <input type="file" class="form-control" value="{{$product->image}}" name="image" id="inputGroupFile02" />
