...
@section('content')
    <a name="submitButton" href="{{ route('products.create') }}" class="btn btn-primary ms-auto mb-3" style="width:auto;">+Add
        product</a>
    <div class="card">
        <h5 class="card-header d-inline" style="display: inline;">All products</h5>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form class="dropdown-item" action="{{ route('products.destroy', $product->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
