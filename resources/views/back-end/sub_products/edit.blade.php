...
@section('title', 'Edit sub product')
@section('content')
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('sub_products.update',$sub_product->id) }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Bar code</label>
                            <input type="number" value="{{ $sub_product->barcode }}" name="barcode" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $sub_product->designation }}" name="designation" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $sub_product->price_ht }}" step="0.1" name="price_ht" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{$sub_product->new_price_ht }}" step="0.1" name="new_price_ht" class="form-control"
                                id="basic-default-fullname" placeholder="12.33" />
                            @error('new_price_ht')
                                <div class="alert text-danger">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $sub_product->VAT }}" step="0.1" name="VAT" class="form-control"
                                id="basic-default-fullname" placeholder="12.33" />
                            @error('VAT')
                                <div class="alert text-danger">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $sub_product->description }}" step="0.1" name="description" class="form-control"
                        ...
                        <div class=" mb-3">
                            ...
                            <input type="file" class="form-control" value="{{$sub_product->image}}" name="image" id="inputGroupFile02" />
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sub_familie_id" class="form-select" id="exampleFormControlSelect1"
                                ...
                                @foreach ($sub_families as $sub_familie)
                                    @if ($sub_product->sub_familie_id == $sub_familie->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select name="brand_id" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                ...
                                @if($sub_product->brand_id == $brand->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select name="unit_id" class="form-select" id="exampleFormControlSelect1"
                                ...
                                @foreach ($units as $unit)
                                    @if ($sub_product->unit_id == $unit->id)
