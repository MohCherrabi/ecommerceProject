    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('orders_details.update',$order_details->id) }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <select name="product_id" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                ...
                                @if($order_details->product_id == $product->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select name="order_id" class="form-select" id="exampleFormControlSelect1"
                                ...
                                @foreach ($orders as $order)
                                    @if ($order_details->order_id == $order->id)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $order_details->quantity }}" name="quantity" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $order_details->price_ht }}" step="0.1" name="price_ht" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $order_details->VAT }}" step="0.1" name="VAT" class="form-control"
                                id="basic-default-fullname" placeholder="12.33" />
                            @error('VAT')
                                <div class="alert text-danger">
                                    {{ $message }}
