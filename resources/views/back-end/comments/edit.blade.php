                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <small class="text-muted float-end">Create comment</small>
                    </div>
                    <div class="card-body">
                      <form action="{{route('comments.update',$comment->id)}}" enctype="multipart/form-data" method="POST" >
                        @csrf
                        @method('PUT')
                          <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Descripton</label>
                            <textarea class="form-control"  name="description" aria-label="With textarea" style="height: 24px;">{{$comment->description}}</textarea>
                            @error('description')
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlSelect1" class="form-label">Blogs</label>
