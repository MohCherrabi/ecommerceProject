...
<head>
    ...
    <title>CherrShop - @yield('title')</title>
...
<body class="biolife-body">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <section class="footer-item">
                            <a href="home-01.html" class="logo footer-logo"><img
                                    src="assets2/images/logo-biolife-1.png" alt="biolife logo" width="135"
                                    height="34"></a>
                            ...
                            <div class="contact-info-block footer-layout simple-info">
                                ...
                                <div class="info-item">
                                    <img src="assets2/images/location-icon.png" width="22" height="26"
                                        alt="" class="icon">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="payment-methods">
                                <ul>
                                    <li><a href="#" class="payment-link"><img src="assets2/images/card1.jpg"
                                                width="51" height="36" alt=""></a></li>
                                    <li><a href="#" class="payment-link"><img src="assets2/images/card2.jpg"
                                                width="51" height="36" alt=""></a></li>
                                    <li><a href="#" class="payment-link"><img src="assets2/images/card3.jpg"
                                                width="51" height="36" alt=""></a></li>
                                    <li><a href="#" class="payment-link"><img src="assets2/images/card4.jpg"
                                                width="51" height="36" alt=""></a></li>
                                    <li><a href="#" class="payment-link"><img src="assets2/images/card5.jpg"
                                                width="51" height="36" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="block-global-contain">
            ...
            <div class="glb-item languages">
                ...
                <ul class="list inline">
                    <li class="list-item"><a href="#"><img src="assets2/images/languages/us.jpg"
                                alt="flag" width="24" height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="assets2/images/languages/fr.jpg"
                                alt="flag" width="24" height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="assets2/images/languages/ger.jpg"
                                alt="flag" width="24" height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="assets2/images/languages/jap.jpg"
                                alt="flag" width="24" height="18"></a></li>
                </ul>
            </div>
        </div>
    ...
    <!--Newletter Popup-->
    <div id="biolife-newsletter-popup" class="modal fade biolife-popup biolife-newsletter-popup-contain"
        role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal"><span
                            class="biolife-icon icon-close-menu"></span></button>
                    <div class="newsletter-block popup-layout newsletter-block_popup-layout">
                        <div class="inner-content">
                            <div class="wrap-title">
                                <span class="sup-title">Sign up to get up to</span>
                                <h3 class="newslt-title">50<sup>%</sup> off</h3>
                            </div>
                            <div class="form-content">
                                <form action="#" name="new-letter-foter" method="post">
                                    <input type="email" class="input-text email" value=""
                                        placeholder="Your email here...">
                                    <button type="submit" class="bnt-submit" name="ok">Get up to 50%
                                        off</button>
                                    <a href="javascript:void(0)" class="close dismiss-newsletter"
                                        data-dismiss="modal">No thank. I’ll let this deal fly away</a>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="biolife-quickview-inner">
                <div class="media">
                    <ul class="biolife-carousel quickview-for"
                        ...
                        <li><img src="assets2/images/details-product/detail_01.jpg" alt="" width="500"
                                height="500"></li>
                        <li><img src="assets2/images/details-product/detail_02.jpg" alt="" width="500"
                                height="500"></li>
                        <li><img src="assets2/images/details-product/detail_03.jpg" alt="" width="500"
                                height="500"></li>
                        <li><img src="assets2/images/details-product/detail_04.jpg" alt="" width="500"
                                height="500"></li>
                        <li><img src="assets2/images/details-product/detail_05.jpg" alt="" width="500"
                                height="500"></li>
                        <li><img src="assets2/images/details-product/detail_06.jpg" alt="" width="500"
                                height="500"></li>
                        <li><img src="assets2/images/details-product/detail_07.jpg" alt="" width="500"
                                height="500"></li>
                    </ul>
                    <ul class="biolife-carousel quickview-nav"
                        ...
                        <li><img src="assets2/images/details-product/thumb_01.jpg" alt="" width="88"
                                height="88"></li>
                        <li><img src="assets2/images/details-product/thumb_02.jpg" alt="" width="88"
                                height="88"></li>
                        <li><img src="assets2/images/details-product/thumb_03.jpg" alt="" width="88"
                                height="88"></li>
                        <li><img src="assets2/images/details-product/thumb_04.jpg" alt="" width="88"
                                height="88"></li>
                        <li><img src="assets2/images/details-product/thumb_05.jpg" alt="" width="88"
                                height="88"></li>
                        <li><img src="assets2/images/details-product/thumb_06.jpg" alt="" width="88"
                                height="88"></li>
                        <li><img src="assets2/images/details-product/thumb_07.jpg" alt="" width="88"
                                height="88"></li>
                    </ul>
                </div>
